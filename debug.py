...
lt_inteira = r'C:\Users\anderson.souza\Documents\PROJETOS\SCRIPT_QUANTITATIVO\ZONA_DE_TESTE\GDB\PL_LOTE_02_F23.gdb\Dados_Projeto\Diretriz_Lote02_F23_Rev6_1210'#linha de transmissão previa
circuito_duplo = 'false'#insira a coluna que divide os circuitos
vert_inicial = ''#a linha começa no vertice 01 ou 02?
fx_interesse = '120'#insira a faixa de interesse
bdgis = r'C:\Users\anderson.souza\Documents\PROJETOS\SCRIPT_QUANTITATIVO\ZONA_DE_TESTE\BDGIS\Novo_teste.gdb\Dados_referenciais'#insira o endereço do banco de dados GIS
temas_extra = ''#multiple values (separados por vírgula) de temas que não estão no banco de dados GIS
fields_extras = ''#multiple values (separados por vírgula) de campos extras que não estão no banco de dados GIS
gdb_path = r'C:\Users\anderson.souza\Documents\PROJETOS\SCRIPT_QUANTITATIVO\ZONA_DE_TESTE\GDB\PL_LOTE_02_F23.gdb'#caminho do geodatabase final, que terá os temas que estão no banco de dados GIS
pasta_quantitativo = r'C:\Users\anderson.souza\Documents\PROJETOS\SCRIPT_QUANTITATIVO\ZONA_DE_TESTE\EXCEL'#pasta onde serão salvos os arquivos excel
atualizar = 'true'
atualizar_vao = 'false'
junkspace = r'C:\Users\anderson.souza\Documents\PROJETOS\SCRIPT_QUANTITATIVO\ZONA_DE_TESTE\JUNKSPACE'
geodesic = 'false'
fields_tema_extra = 'false'
